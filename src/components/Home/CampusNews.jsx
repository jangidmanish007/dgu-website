...
const campusNews = [
    ...
    },
    {
        ...
        title: ' DBS Global University Signs MoU with IIT Ropar to Advance Future-Ready Learning, Technology and Innovation',
        excerpt:
            'Strategic academic collaboration to expand opportunities in Artificial Intelligence, Drone Technology',
        href: '/campus-news/independence-day-2026',
    },
    {
        id: 5,
    ...
    },
    {
        ...
        excerpt:
            'An informative session on SAP Learning Hub and Career Opportunities was delivered by Mr. Rahul Sachdeva',
        href: '/campus-news/independence-day-2026',
    },
    {
        id: 7,
    ...
    },
    {
        ...
        excerpt: 'DBS Global University (DGU) is recognised with the SAP University Alliances Award APAC 2026, honouring 17+ years of SAP-...',
    ...
    },
    {
        ...
        title: 'Harela Celebrated with Traditional Rituals, Plantation Drive and Cultural Performances at DBS Global University',
        excerpt: 'Harela Celebrated with Traditional Rituals, Plantation Drive and Cultural Performances at DBS Global University',
    ...
    },
    {
        ...
        title: 'AMBA & BGA Strategic Engagement Manager Visits DBS Global University to Strengthen Global Academic Collaboration',
    ...
    },
    {
        ...
        excerpt: 'Viksit Bharat Young Leaders Dialogue 2026 Brings Youth Leadership and Nation-Building Conversations to the Fore',
    ...
    },
    {
        ...
        title: 'Students Excel in Global Finance Certifications, Reinforcing the Universitys Commitment to Academic Excellence',
        excerpt: 'Shlok Gupta and Yash Kabra have successfully cleared the Chartered Financial Analyst (CFA) Level I examination',
    ...
    },
    {
        ...
        excerpt: 'Research published in one of the world\'s top 25% environmental journals "Springer Nature\'s Environmental Sc...',
    ...
    },
    {
        ...
        title: 'NIPM Chandigarh Chapter Delegation Visits DBS Global University to Explore Academic and Industry Collaborations',
        excerpt: 'DBS Global University welcomed a distinguished delegation from the National Institute of Personnel Management (NIPM), C...',
    ...
    },
    {
        ...
        title: 'First-Year SOAC Student Earns International Recognition with Springer, Scopus-Indexed Cybersecurity Research',
        excerpt: 'DBS Global University proudly celebrates a remarkable international research achievement by Parneet Kaur, a first-year s...',
    ...
    },
    {
        ...
        excerpt: 'Students of the School of Advanced Computing (SOAC) have earned international recognition with the acceptance of their r...',
    ...
    },
    {
        ...
        excerpt: 'At the University, learning extends far beyond the classroom. Alongside academic excellence, students are nurtured throu...',
    ...
    },
    {
        ...
        excerpt: 'The University has been honoured with the prestigious Zee Uttarakhand Udaan Award for Excellence in Education, recognisi...',
...
const admissionNews = [
    {
        ...
        excerpt:
            'DBS Global University has announced multiple career opportunities for experienced professionals …',
...
function SectionAccent() {
    return <div className="mt-1.5 h-[3px] w-9 bg-[#68176b] rounded-full" />;
}
...
function CampusCard({ item }) {
    return (
        <Link
            href={item.href}
             className="group flex h-[460px] w-full flex-col rounded-xl border border-gray-200 overflow-hidden bg-white shadow-sm transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl"
        >
            ...
            <div className="flex flex-col gap-2 p-4 flex-1">
                <h3 className="text-sm sm:text-[15px] font-bold text-gray-900 leading-snug line-clamp-3">
                    {item.title}
                </h3>
                <p className="text-xs sm:text-sm text-[#68176b] leading-relaxed line-clamp-3 flex-1">
                    {item.excerpt}
                </p>
                <span className="inline-flex items-center gap-1 text-sm font-medium text-[#68176b] mt-1 group-hover:gap-2 transition-all duration-200">
...
function AdmissionCard({ item }) {
    return (
        <Link
            href={item.href}
            className="
        group block border-b border-gray-200 last:border-b-0
        py-4 first:pt-0
      ...
      "
        >
            ...
            {/* title */}
            <h4 className="text-sm font-bold text-gray-900 leading-snug mb-1 group-hover:text-[#68176b] transition-colors duration-200">
                {item.title}
            </h4>

            {/* excerpt */}
            <p className="text-xs sm:text-sm text-[#68176b] leading-relaxed line-clamp-2 mb-2">
                {item.excerpt}
            </p>

            <span className="inline-flex items-center gap-1 text-sm font-medium text-[#68176b] group-hover:gap-2 transition-all duration-200">
                Read More <ArrowRight className="w-4 h-4" />
            </span>
        </Link>
    );
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] xl:grid-cols-[1fr_380px] gap-8 lg:gap-10">
                    ...
                    <div className="min-w-0">
                        ...
                        <div className="flex items-end justify-between mb-5 sm:mb-6">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Campus News</h2>
                    ...
                    <div>
                        ...
                        <div className="mb-5 sm:mb-6">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Admission News</h2>
                            <p className="text-sm text-[#68176b] mt-0.5">Important updates &amp; deadlines</p>
                            <SectionAccent />
                        </div>
